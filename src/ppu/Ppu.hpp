    ...
    */
    class Ppu
    {
        ...
        public:
            ...
            * @return 1 or 32
            */
            uint8_t cr_increment_vram_addr();
            ...
            * @param status 
            */
            void _sr_set(uint8_t flag, bool status);
            ...
            * @return false 
            */
            bool _sr_contains(uint8_t flag) const;
